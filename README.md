[Garage Door Controller v1.1](https://github.com/brandon-bailey/garage-door-controller)
======================
...
4. **Install the controller application**
    ...
    `svn co https://github.com/brandon-bailey/garage-door-controller/trunk ~pi/garage-door-controller`
